...
class CalendarComponent extends React.Component {
  ...
  get_initial_events() {
    console.log("get_initial_events()");
    // TO DO GET REQUEST
    console.log("GET request /calender/calendar_id", this.props.calendar_id)


    let initialEvents;
    if (this.props.calendar_id === "1") {
      initialEvents = defaultEvents;
    } else if (this.props.calendar_id === "2") {
      initialEvents = defaultEventsBis;
    }
  ...
  setNewAppointment() {
    ...
    console.log("POST request /calendar/calendar_id/add_event", this.state);
    console.log("calendar_id", this.props.calendar_id);
  ...
  render() {
    if (!this.state.isInitialized) { this.get_initial_events() }
    console.log("render()");
